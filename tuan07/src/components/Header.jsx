function Header() {
    return (
        <div className="header flex items-center justify-between shadow shadow-gray-400 rounded-b-md p-4 w-full" style={{ boxShadow: "0 4px 6px -2px rgba(156, 163, 175, 0.5)" }}>
